...
export function AboutUsComponents() {
  return (
    <motion.section
      ...
      className="my-48"
    >
      <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 items-start gap-6">
        {/* LEFT SECTION */}
        <motion.div
          variants={fadeUp}
        ...
        >
          ...
          <motion.div variants={fadeUp} className="border rounded-xl p-6">
            <div className="bg-[#f97316]/20 p-3 rounded-xl hidden">
              <Image
          ...
          <motion.div variants={fadeUp} className="border rounded-xl p-6">
            ...
            <p className="text-[#717182] text-[14px] sm:text-[16px] leading-7">
              Elevare Advisory & Certified Accountants was founded to close the
